...
def get_stock_price(stock, strt_dt, end_dt):
    ...
    :Parameters:
        ...
        end_dt: str
            ...
            Default is now
    'closing price' or 'adjusted closing price' is used because - gives you
    the most info you need to focus for a day.
    DONNOT use the following:
    *opening price is not reliable (subject to manipulation because of
    timelag between Asian and US markets; so there will be a huge difference)
...
def trending_by_country(company, country, strt_dt, end_dt):
    ...
    Sentiment analyzer expects a full sentence as input and returns scores
    along thes dimensions:
    ...
    try:
        ...
        for date, source, title in zip(news_articles['publishedAt'],
